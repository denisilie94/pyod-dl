...
class SKDL_D(BaseDetector):
    def __init__(self, n_components_std, n_nonzero_coefs_std, n_iterations_std,
                 train_proc_std, train_drop_proc_std, train_proc,
                 train_drop_proc, learning_method_std, n_components,
                 n_nonzero_coefs, n_iterations, dl_kernel, learning_method,
                 contamination, D0=None):
        # standard DL
